					...
					?
						<ApolloProvider client={this.state.client}>
							<Navbar network={this.state.network} {...this.props} />
								...
								<Route exact path={ `/${this.state.network}/about-us`          } render={ (props) => <About    emitter={this.props.emitter} network={this.state.network} config={this.props.config} routing={props}/> } />
								...
								<Route exact path={ `/${this.state.network}/nodeview/:address` } render={ (props) => <Nodeview emitter={this.props.emitter} network={this.state.network} config={this.props.config} routing={props}/> } />
						</ApolloProvider>
					:
						<Loading/>
				}
